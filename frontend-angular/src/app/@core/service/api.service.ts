...
import { APIData , SlotData, Session ,Request, CandicateSession , Profile , User , FileData } from '../service/models/api.data.structure';
@Injectable()
export class APIService {
  ...
  addSpeciality(email,speciality): Observable<APIData> {
    return this.http.post<APIData>(this.apiUrl + 'expert/addSpeciality',{email:email,speciality:speciality})
    .catch(this.errorHandler);
  }
}
